...
c+"'>"+('<div class="icon" title="'+c+'"></div>')+("<div class='username' title=\"Nicknames: "+b+'">'+e.identity+"</div>")+"</div></div>"}function r(a,c){var e=k(a).find(".user-list-wrapper .user-list");a=e.find(".mod-section-body");var m=e.find(".guest-section-body"),d=e.find(".regular-section-body");e=e.find(".user-entry[data-identity="+c.identity+"]");if(0===c.nicknames.length)e.remove();else{var f=d;b(c.roles)?f=a:vga.irc.getMostSignificantRole(c.roles)===vga.irc.roles.guest&&(f=m);0!==e.length&&
e.remove();f.append(u(c));v(f)}a.parent().toggleClass("hidden",0==a.find("div").length);m.parent().toggleClass("hidden",0==m.find("div").length);d.parent().toggleClass("hidden",0==d.find("div").length)}function z(a,c){a=k(a).find(".user-list-wrapper .user-list");var e=a.find(".mod-section-body"),m=a.find(".guest-section-body"),d=a.find(".regular-section-body");e.html("");m.html("");d.html("");c&&vga.util.forEach(c,function(a,c){a=d;b(c.roles)?a=e:vga.irc.getMostSignificantRole(c.roles)===vga.irc.roles.guest&&
(a=m);a.append(u(c));v(a)});e.parent().toggleClass("hidden",0===e.find("div").length);m.parent().toggleClass("hidden",0===m.find("div").length);d.parent().toggleClass("hidden",0===d.find("div").length)}function v(a){a.html(a.find("div[data-identity]").sort(function(a,e){a=($(a).data("identity")||"").toLowerCase();e=($(e).data("identity")||"").toLowerCase();return a<e?-1:a>e?1:0}))}var q=$(".channel-container"),w=$("#settings-container"),A=$("#channel"),x=$("#nickname"),B=$("#password");vga.irc.chat=
function(a){a=a||{};if(!a.url)throw new vga.util.exception("irc.chat","The url cannot be empty.");if(!a.hostname)throw new vga.util.exception("irc.chat","The hostname must be set.");if(!a.port)throw new vga.util.exception("irc.chat","The port must be set.");vga.irc.chat.CLIENT_VERSION=new vga.util.version(1,1,0);this._userChannels={};this._smoothScrollState=vga.irc.smoothScrollState.stopped;this._hostname=a.hostname;this._port=a.port;this._ssl=void 0===a.ssl?!1:a.ssl;this._debug=void 0==a.debug?!1:
a.debug;this._wallRegEx=a.wallRegEx||/^%! ([^\r\n]*)/;this._defaultChannel=a.defaultChannel;this._themes=a.themes||[];this._showUserJoinLeaveMessage=void 0!==a.showUserJoinLeaveMessage?a.showUserJoinLeaveMessage:!1;this._smoothScroll=void 0!==a.smoothScroll?a.smoothScroll:!0;this._timedBanDurationInSeconds=void 0!==a.timedBanDurationInSeconds?a.timedBanDurationInSeconds:300;this._nicknameColorSeedFunction=a.nicknameColorSeedFunction;var e=void 0!==a.consolidateNicknames?a.consolidateNicknames:!1,
b=void 0!==a.enableReconnect?a.enableReconnect:!0,c=!this._defaultChannel;void 0!==a.enableFrashShowMode&&a.enableFrashShowMode&&this.setFrashShowMode(!0);this._debug&&vga.util.enableDebug();this.bindEvents();this.onLoadSettings();console.log("[vga.irc.chat]: Starting chat version: "+vga.irc.chat.CLIENT_VERSION.toString());this.connector=new vga.irc.connector.kiwi.connector(a.url,{supportConcurrentChannelJoins:a.supportConcurrentChannelJoins,autoJoinChannel:c,attemptReconnect:b,consolidateNicknames:e,
listeners:[this]})};vga.irc.chat.prototype.writeMessage=function(e,m,d,f){f=f||"message";var y=""+("action"===f?"allowColor":""),h="",g=this._userChannels[e];g&&(g=g[this.connector.getMyUserKey()])&&b(g.roles)&&(h='<span class="timeout"><i class="fa fa-ban" role="button" title="Timeout Chatter!"></i></span>');this._wallRegEx.test(d)&&b(m.roles)&&(g=this._wallRegEx.exec(d),1<g.length&&(d=g[1],y="modbroadcast"));d=vga.util.encodeHTML(d).trim();g=void 0!==m?m.identity.trim():"undefined";var k=a(void 0!==
m?m.roles:vga.irc.roles.shadow);m=m.identity;for(var n=this._nicknameColorSeedFunction&&this._nicknameColorSeedFunction()||0,l=0;l<m.length;l++)n+=m.charCodeAt(l);m=""+(n%7+1);n=g;"privateTO"===f?n="To ["+n+"]":"privateFROM"===f&&(n="From ["+n+"]");n=(n[0]||"").toLocaleUpperCase()+n.substring(1);c(e).append("<div class='user-entry nickColor"+m+"' data-identity='"+g+"'><div class='role "+k+"'>"+('<div class="icon" title="'+k+'"></div>'+h)+("<span class='username allowColor'>"+n.trim()+("action"!==
f?":&nbsp":"&nbsp")+"</span>")+("<span class='message "+y+"'>"+d+"</span>")+"</div></div>")};vga.irc.chat.prototype.showToggleSetting=function(a,b){w.find(".settings-item[data-settings-type='"+a+"']").toggleClass("hidden",!b)};vga.irc.chat.prototype.toggleSettingItem=function(a,b){w.find(".settings-item[data-settings-type='"+a+"'] > i").toggleClass("fa-toggle-off",!b).toggleClass("fa-toggle-on",b)};vga.irc.chat.prototype.setFrashShowMode=function(a){this._frashShowMode=a;this.showToggleSetting("join-mode",
!a);this.showToggleSetting("frash-show-mode",!0);this.toggleSettingItem("frash-show-mode",a);$("html").toggleClass("frash-show-mode",a)};vga.irc.chat.prototype.startThemes=function(){var a=this,b=function(){a._themesIntervalId=setTimeout(function(){var e=new Date;a._themes.forEach(function(a){var b=new Date(a.beginDate),c=new Date(a.endDate);b.setFullYear(e.getFullYear());c.setFullYear(e.getFullYear());$("body").toggleClass(a.name,e>=b&&e<=c)});b()},1E3)};b()};vga.irc.chat.prototype.stopThemes=function(){clearTimeout(this._themesIntervalId)};
vga.irc.chat.prototype.startSmoothScrolling=function(){var a=this,b=function(){a._smoothScrollState!==vga.irc.smoothScrollState.stopped&&(a._smoothScrollIntervalId=setTimeout(function(){if(a._smoothScrollState===vga.irc.smoothScrollState.started){var e=q.find(":not(#channel-tab-template)").find(".channel-window");$.each(e,function(e,b){e=$(b).prop("scrollHeight");if(a._smoothScroll){var c=$(b).prop("scrollTop"),d=c+$(b).height(),m=1;d<e-140&&(m=Math.round(1+(e-d)/50));e=c+m}$(b).scrollTop(e)})}b()},
33))};this._smoothScrollState=vga.irc.smoothScrollState.started;b()};vga.irc.chat.prototype.stopSmoothScrolling=function(){this._smoothScrollState=vga.irc.smoothScrollState.stopped;clearTimeout(this._smoothScrollIntervalId)};vga.irc.chat.prototype.pauseSmoothScrolling=function(a){this._smoothScrollState!==vga.irc.smoothScrollState.stopped&&(this._smoothScrollState=a?vga.irc.smoothScrollState.paused:vga.irc.smoothScrollState.started)};vga.irc.chat.prototype.connect=function(a,b,c){this.connector.connect({nick:a.trim(),
hostname:this._hostname,port:this._port,ssl:this._ssl,password:b.trim(),channel:(c||this._defaultChannel||"").trim()});return this};vga.irc.chat.prototype.close=function(a){this.connector&&this.connector.disconnect(a);return this};vga.irc.chat.prototype.send=function(a,b){return a?"/"===b[0]?(b=b.splitFirstOccurrence(" "),this.handleUserCommand(a,b.first.trim().toLowerCase(),b.second)):this.handleUserMessage(a,b):this};vga.irc.chat.prototype.join=function(a){this._userChannels[a]?p(k(a)):this.connector&&
this.connector.join(a);return this};vga.irc.chat.prototype.leave=function(a,b){this._userChannels[a]&&(this.connector&&this.connector.leave(a,b),vga.util.forEach(this._userChannels,function(a,b){}),p(k(a)));return this};vga.irc.chat.prototype.emote=function(a,b){this.connector.emote(a,b);var e=this._userChannels[a];e&&(e=e[this.connector.getMyUserKey()],this.writeMessage(a,e,b,"action"))};vga.irc.chat.prototype.whisper=function(a,b,c){this.connector&&this.connector.send(b,c);var e=this._userChannels[a];
