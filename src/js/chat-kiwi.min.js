...
"The url cannot be empty.");if(!a.hostname)throw new vga.util.exception("irc.chat","The hostname must be set.");if(!a.port)throw new vga.util.exception("irc.chat","The port must be set.");vga.irc.chat.CLIENT_VERSION=new vga.util.version(1,1,1);this._userChannels={};this._smoothScrollState=vga.irc.smoothScrollState.stopped;this._hostname=a.hostname;this._port=a.port;this._ssl=void 0===a.ssl?!1:a.ssl;this._debug=void 0==a.debug?!1:a.debug;this._wallRegEx=a.wallRegEx||/^%! ([^\r\n]*)/;this._defaultChannel=
