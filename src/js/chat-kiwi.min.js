...
$jscomp.polyfill("WeakMap",function(a){function c(a){$jscomp.owns(a,k)||$jscomp.defineProperty(a,k,{value:{}})}function h(a){var b=Object[a];b&&(Object[a]=function(f){c(f);return b(f)})}if(function(){if(!a||!Object.seal)return!1;try{var d=Object.seal({}),b=Object.seal({}),f=new a([[d,2],[b,3]]);if(2!=f.get(d)||3!=f.get(b))return!1;f.delete(d);f.set(b,4);return!f.has(d)&&4==f.get(b)}catch(q){return!1}}())return a;var k="$jscomp_hidden_"+Math.random().toString().substring(2);h("freeze");h("preventExtensions");
h("seal");var d=0,g=function(a){this.id_=(d+=Math.random()+1).toString();if(a){$jscomp.initSymbol();$jscomp.initSymbolIterator();a=$jscomp.makeIterator(a);for(var b;!(b=a.next()).done;)b=b.value,this.set(b[0],b[1])}};g.prototype.set=function(a,b){c(a);if(!$jscomp.owns(a,k))throw Error("WeakMap key fail: "+a);a[k][this.id_]=b;return this};g.prototype.get=function(a){return $jscomp.owns(a,k)?a[k][this.id_]:void 0};g.prototype.has=function(a){return $jscomp.owns(a,k)&&$jscomp.owns(a[k],this.id_)};g.prototype.delete=
function(a){return $jscomp.owns(a,k)&&$jscomp.owns(a[k],this.id_)?delete a[k][this.id_]:!1};return g},"es6","es3");$jscomp.MapEntry=function(){};
$jscomp.polyfill("Map",function(a){if(!$jscomp.ASSUME_NO_NATIVE_MAP&&function(){if(!a||!a.prototype.entries||"function"!=typeof Object.seal)return!1;try{var b=Object.seal({x:4}),f=new a($jscomp.makeIterator([[b,"s"]]));if("s"!=f.get(b)||1!=f.size||f.get({x:4})||f.set({x:4},"t")!=f||2!=f.size)return!1;var d=f.entries(),c=d.next();if(c.done||c.value[0]!=b||"s"!=c.value[1])return!1;c=d.next();return c.done||4!=c.value[0].x||"t"!=c.value[1]||!d.next().done?!1:!0}catch(v){return!1}}())return a;$jscomp.initSymbol();
$jscomp.initSymbolIterator();var c=new WeakMap,h=function(b){this.data_={};this.head_=g();this.size=0;if(b){b=$jscomp.makeIterator(b);for(var a;!(a=b.next()).done;)a=a.value,this.set(a[0],a[1])}};h.prototype.set=function(b,a){var f=k(this,b);f.list||(f.list=this.data_[f.id]=[]);f.entry?f.entry.value=a:(f.entry={next:this.head_,previous:this.head_.previous,head:this.head_,key:b,value:a},f.list.push(f.entry),this.head_.previous.next=f.entry,this.head_.previous=f.entry,this.size++);return this};h.prototype.delete=
function(b){b=k(this,b);return b.entry&&b.list?(b.list.splice(b.index,1),b.list.length||delete this.data_[b.id],b.entry.previous.next=b.entry.next,b.entry.next.previous=b.entry.previous,b.entry.head=null,this.size--,!0):!1};h.prototype.clear=function(){this.data_={};this.head_=this.head_.previous=g();this.size=0};h.prototype.has=function(b){return!!k(this,b).entry};h.prototype.get=function(b){return(b=k(this,b).entry)&&b.value};h.prototype.entries=function(){return d(this,function(b){return[b.key,
b.value]})};h.prototype.keys=function(){return d(this,function(b){return b.key})};h.prototype.values=function(){return d(this,function(b){return b.value})};h.prototype.forEach=function(b,a){for(var f=this.entries(),d;!(d=f.next()).done;)d=d.value,b.call(a,d[1],d[0],this)};h.prototype[Symbol.iterator]=h.prototype.entries;var k=function(b,a){var f=a&&typeof a;"object"==f||"function"==f?c.has(a)?f=c.get(a):(f=""+ ++l,c.set(a,f)):f="p_"+a;var d=b.data_[f];if(d&&$jscomp.owns(b.data_,f))for(b=0;b<d.length;b++){var h=
d[b];if(a!==a&&h.key!==h.key||a===h.key)return{id:f,list:d,index:b,entry:h}}return{id:f,list:d,index:-1,entry:void 0}},d=function(b,a){var f=b.head_;return $jscomp.iteratorPrototype(function(){if(f){for(;f.head!=b.head_;)f=f.previous;for(;f.next!=f.head;)return f=f.next,{done:!1,value:a(f)};f=null}return{done:!0,value:void 0}})},g=function(){var b={};return b.previous=b.next=b.head=b},l=0;return h},"es6","es3");
...
c.prototype.values=function(){return this.map_.values()};c.prototype.keys=c.prototype.values;c.prototype[Symbol.iterator]=c.prototype.values;c.prototype.forEach=function(a,c){var d=this;this.map_.forEach(function(g){return a.call(c,g,g,d)})};return c},"es6","es3");$jscomp.findInternal=function(a,c,h){a instanceof String&&(a=String(a));for(var k=a.length,d=0;d<k;d++){var g=a[d];if(c.call(h,g,d,a))return{i:d,v:g}}return{i:-1,v:void 0}};
...
vga.webchat.connector.kiwi.connector.prototype.normalizeNickname=function(b){return this._consolidateNicknames?b.replace(/_[0-9]$/g,""):b};vga.webchat.connector.kiwi.connector.prototype.generateUserKey=function(b){return this.normalizeNickname(b).toLocaleLowerCase()};vga.webchat.connector.kiwi.connector.prototype.generateChannelKey=function(b){return b.toLocaleLowerCase()};vga.webchat.connector.kiwi.connector.prototype.connect=function(b){b=b||{};if(this._protocol){this._protocol.open(b);var a=this._protocol.getState();
if(a===vga.webchat.connector.kiwi.STATES.CLOSED||a===vga.webchat.connector.kiwi.STATES.OPENING)this._autoJoinChannel=(b.channel||"").toLowerCase(),this._userListByChannel={},this._prefixMap={},this._nickname=this._identity=b.nick}return this};vga.webchat.connector.kiwi.connector.prototype.send=function(b,a){b&&a&&(vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.send]: Sending to ("+b+"): "+a+"."),this._protocol&&this._protocol.sendIRCData("privmsg",{target:b,msg:a}));return this};vga.webchat.connector.kiwi.connector.prototype.emote=
function(b,a){b&&a&&(vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.emote]: Sending to ("+b+"): "+a+"."),this._protocol&&this._protocol.sendIRCData("ctcp",{is_request:!0,type:"ACTION",target:b,params:a}));return this};vga.webchat.connector.kiwi.connector.prototype.join=function(b){if(b)return vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.join]: Attempting to join channel: "+b+"."),this._protocol&&this._protocol.sendIRCData("join",{channel:b,key:""}),this;vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.join]: Invalid channel.",
b);return this};vga.webchat.connector.kiwi.connector.prototype.leave=function(b,a){if(b)return vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.leave]: Attempting to leave channel: "+b+"."),this._protocol&&this._protocol.sendIRCData("part",{channel:b,message:a}),this;vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.leave]: Invalid channel.",b);return this};vga.webchat.connector.kiwi.connector.prototype.setMode=function(b,a,d){if(b)return a=g[a],vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.setMode]: (Attempting to "+
(d==vga.webchat.roleModeAction.add?"add":"remove")+" the mode "+a+" on channel: "+b+")."),this._protocol&&this._protocol.sendIRCData("raw",{data:"MODE "+b+" "+(d==vga.webchat.roleModeAction.add?"+":"-")+a}),this;vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.setMode]: (Invalid channel "+b+").");return this};vga.webchat.connector.kiwi.connector.prototype.setUserStatus=function(b,a,d,c,g){if(b){var f="";vga.webchat.bitArray.contains(d,vga.webchat.status.banned)&&(a=vga.webchat.connector.kiwi.banMaskToApply.replace("{identity}",
""+a+(this._consolidateNicknames?"":"*")),vga.webchat.bitArray.contains(d,vga.webchat.status.timed)?(f="tb",d=(g||{duration:0}).duration||900,this._protocol&&this._protocol.sendIRCData("raw",{data:"TBAN "+b+" "+d+" m:"+a})):(f="b",this._protocol&&this._protocol.sendIRCData("raw",{data:"MODE "+b+" "+(c==vga.webchat.roleModeAction.add?"+":"-")+f+" "+a})));vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.setUserStatus]: (Attempting to "+(c==vga.webchat.roleModeAction.add?"add":"remove")+
" the status "+f+" on channel: "+b+").");return this}vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.setMode]: (Invalid channel "+b+").");return this};vga.webchat.connector.kiwi.connector.prototype.setNickname=function(b){b&&(this._nickname=b,vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.nick]: (Attempting to change nickname to: "+b+")."),this._protocol&&this._protocol.sendIRCData("nick",{nick:b}));return this};vga.webchat.connector.kiwi.connector.prototype.kick=function(b,
a){b&&(vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.nick]: (Attempting to kick: "+a+")."),this._protocol&&this._protocol.sendIRCData("kick",{channel:b,nick:a,reason:"Bye!"}));vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.setMode]: (Invalid channel "+b+").");return this};vga.webchat.connector.kiwi.connector.prototype.disconnect=function(b){this._nickname=this._identity="";this._protocol&&(vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.disconnect]: (Attempting to disconnect with message: "+
(b||"undefined")+")."),this._protocol.sendIRCData("quit",{message:b}),this._protocol.close(b));return this};vga.webchat.connector.kiwi.connector.prototype.dispose=function(){this.disconnect();this._protocol=vga.util.safeDispose(this._protocol);return this};vga.webchat.connector.kiwi.connector.prototype.onConnect=function(b){var a="";this._numberOfReconnectsAttempted=0;vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.onConnect]: (AutoJoinChannel: "+(""!==this._autoJoinChannel?this._autoJoinChannel:
"none")+", Nick: "+b.nick+").");""!==this._autoJoinChannel&&(this.join(this._autoJoinChannel),a=this._autoJoinChannel);this._listener.invokeListeners("connect",{channelKey:a})};vga.webchat.connector.kiwi.connector.prototype.onDisconnect=function(b){vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.onDisconnected]: (Reason: '"+b.reason+"', closedByServer: "+b.closedByServer+", existingConnection: "+b.existingConnection+").");var a="Unable to reach the server.  Try again later.";if(this._attemptReconnect&&
b.closedByServer&&b.existingConnection){if(this._numberOfReconnectsAttempted<this._maxNumberOfReconnectAttempts){this._numberOfReconnectsAttempted++;vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.onDisconnected]: (Attempt to reconnect is enabled, attempting try: "+this._numberOfReconnectsAttempted+").");this._listener.invokeListeners("reconnect");return}a="(Exceeded the number of retry event: "+this._maxNumberOfReconnectAttempts+"). Giving up.";vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.onDisconnected]: "+
a)}this._protocol&&this._protocol.close();this._listener.invokeListeners("disconnect",{closedByServer:b.closedByServer,reason:a})};vga.webchat.connector.kiwi.connector.prototype.onOptions=function(b){var a=this;vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.onOptions].");0===vga.util.propertyCount(this._prefixMap)&&b.options&&b.options.PREFIX&&b.options.PREFIX.forEach(function(b){b.symbol&&b.mode&&(a._prefixMap[b.symbol]=b.mode)})};vga.webchat.connector.kiwi.connector.prototype.onNick=
function(b){vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.onNick].",b);var a=this.normalizeNickname(b.nick);if(a=this.isMe(a))this._nickname=b.newnick;var d=this.normalizeNickname(b.newnick);this._listener.invokeListeners("nick",{userKey:this.generateUserKey(b.nick),newUserKey:this.generateUserKey(b.newnick),identity:d,nickname:b.nick,newNickName:b.newnick,isMe:a})};vga.webchat.connector.kiwi.connector.prototype.onMessage=function(b){vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.onMessage]: (Target: "+
b.target+", Type: "+b.type+", Nickname: "+b.nick+", Message: "+b.msg+").");var a=0<b.target.length&&"#"===b.target[0];"message"!==b.type&&"action"!==b.type||this._listener.invokeListeners("message",{userKey:this.generateUserKey(b.nick),identity:this.normalizeNickname(b.nick),nickname:b.nick,isChannel:a,target:a?this.generateChannelKey(b.target):this.generateUserKey(b.target),message:b.msg,type:b.type})};vga.webchat.connector.kiwi.connector.prototype.onTopic=function(b){var a=this.generateChannelKey(b.channel);
vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.onTopic]: (Topic: "+b.topic+", Channel: "+a+").");this._listener.invokeListeners("topic",{topic:b.topic,channelKey:a})};vga.webchat.connector.kiwi.connector.prototype.onChannel=function(a){var b=this.generateChannelKey(a.channel);vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.onChannel]: (Channel: "+b+", Identity: "+a.ident+", Type: "+a.type+").");var d="kick"!==a.type?a.nick:a.kicked,c=this.normalizeNickname(d),g=this.isMe(d);
this._autoJoinChannelComplete="join"===a.type&&b===this._autoJoinChannel&&g;"join"===a.type?(g&&this._protocol&&this._protocol.sendIRCData("raw",{data:"MODE "+this._autoJoinChannel}),this._knownIdentities.add(c)):"part"===a.type&&this._knownIdentities.delete(c);this._listener.invokeListeners(""+a.type,{channelKey:b,userKey:this.generateUserKey(d),identity:c,nickname:d,isMe:this.isMe(c)})};vga.webchat.connector.kiwi.connector.prototype.onChannelInfo=function(a){vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.onChannelInfo]: (Channel: "+
a.channel+").");if(a.modes){var b=vga.webchat.channelmodes.none;a.modes.forEach(function(a){a&&"+"===a.mode.substring(0,1)&&(b=vga.webchat.bitArray.add(b,d[a.mode.substring(1,2)]))});this._listener.invokeListeners("channelmode",{channelKey:this.generateChannelKey(a.channel),action:vga.webchat.roleModeAction.add,modes:b})}};vga.webchat.connector.kiwi.connector.prototype.onQuit=function(a){vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.onQuit]: (Nick: "+a.nick+", Identity: "+a.ident+
", Message: "+a.message+").");var b=this.normalizeNickname(a.nick);this._listener.invokeListeners("quit",{userKey:this.generateUserKey(a.nick),identity:b,nickname:a.nick,isMe:this.isMe(b)});this._knownIdentities.delete(b)};vga.webchat.connector.kiwi.connector.prototype.onMode=function(a){var b=this;vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.onMode].");0!==a.modes.length&&a.modes.forEach(function(c){var g=(c.mode||"").trim();if(0!==g.length){var f=vga.webchat.roleModeAction.add;
1<g.length&&(f="-"===g.substring(0,1)?vga.webchat.roleModeAction.remove:vga.webchat.roleModeAction.add,g=g.substring(1,2));var h=b.generateChannelKey(a.target);if(null!==c.param)b.onUserMode(h,c.param,f,g);else b._listener.invokeListeners("channelmode",{channelKey:h,action:f,modes:vga.webchat.bitArray.compileBitArray([g],function(a){return d[a]})})}})};vga.webchat.connector.kiwi.connector.prototype.onUserMode=function(a,d,c,g){a={channelKey:a,action:c};if(k[g]){g=k[g];if(g===vga.webchat.status.banned){c=
vga.webchat.connector.kiwi.banMaskRegEx.exec(d);(null===c||4>c.length)&&vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.onMode]: Invalid banmask: "+d);d=c[2];c=c[3];if("*"===d.trim()&&"*"===c.trim())return;if("*"===d)if(-1<c.indexOf("*")){var b=new RegExp(c.replace("*",vga.webchat.connector.kiwi.wildCardMaskRegString),"i"),f=[];this._knownIdentities.forEach(function(a){b.test(a)&&f.push(a)});var l=b.test(this.getMyNickname());a.identities=f}else d=c}c="status";a.status=g}else c="role",
a.roles=vga.webchat.bitArray.compileBitArray([g],function(a){return h[a]},vga.webchat.roles.shadow);g=this.normalizeNickname(d);a.userKey=this.generateUserKey(d);a.identity=g;a.nickname=d;a.isMe=void 0!==l?l:this.isMe(g);this._listener.invokeListeners(c,a)};vga.webchat.connector.kiwi.connector.prototype.onUserlist=function(a){var b=this;vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.onUserlist].");var d=0<vga.util.propertyCount(this._prefixMap)?this._prefixMap:c,g=this.generateChannelKey(a.channel),
k=this._userListByChannel[g];k||(this._userListByChannel[g]=k={});a.users.forEach(function(a){for(var c=[],g=0,f=0;f<a.nick.length&&d.hasOwnProperty(a.nick[f]);f++)c.push(d[a.nick[f]]),g++;c=a.nick.substring(g);g=b.normalizeNickname(c);f=b.generateUserKey(c);b._knownIdentities.add(g);var l=k[f];l?l.addNickname(c):(a=vga.webchat.bitArray.compileBitArray(a.modes,function(a){return h[a]},vga.webchat.roles.shadow),k[f]=new vga.webchat.userEntity(g,[c],a))})};vga.webchat.connector.kiwi.connector.prototype.onUserlistEnd=
function(a){a=this.generateChannelKey(a.channel);vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.onUserListEnd]: Channel: "+a);this._userListByChannel&&a&&this._userListByChannel.hasOwnProperty(a)&&(vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.onUserListEnd]: (UserList: "+this._userListByChannel[a].users+")."),this._listener.invokeListeners("userlist",{users:this._userListByChannel[a],channelKey:a}))};vga.webchat.connector.kiwi.connector.prototype.onError=function(b){vga.util.debuglog.info("[vga.webchat.connector.kiwi.connector.onError]: (Error: "+
...
(function(){function a(a){a=a||{};return{nick:a.nick,hostname:a.hostname,port:a.port,ssl:a.ssl,password:a.password}}function c(a,c){return{method:a,params:c}}function h(a,g){return c(vga.webchat.connector.kiwi.PROXY_PREFIX+"."+a,g||[])}vga.webchat.connector.kiwi.PACKET_STATUS={OPEN:0,CLOSE:1,PING:2,PONG:3,MESSAGE:4,UPGRADE:5,NOOP:6};vga.webchat.connector.kiwi.STATES={CLOSED:0,CLOSING:1,OPENING:2,SOCKET_OPENED:3,PROXY_OPENED:4,PROXY_CONNECTED:5,OPENED:6};var k={connect:"onConnect",channel:"onChannel",
...
typeof a?JSON.stringify(a):a):c,this._socket.send(a,h));return this};vga.webchat.connector.kiwi.protocolwrapper.prototype.sendIRCData=function(a,g){return this.sendRawData(c(vga.webchat.connector.kiwi.IRC_PREFIX+"."+a,[(this._connectionInfo||{connectionId:0}).connectionId,g,null]))};vga.webchat.connector.kiwi.protocolwrapper.prototype.open=function(a){a=a||{};this._state=vga.webchat.connector.kiwi.STATES.OPENING;this._socket&&(vga.util.debuglog.info("[vga.webchat.connector.kiwi.protocolwrapper.open]: Attempting to open."),
...
b()},d)};b()}if(!this._pingId){var f=this._connectionInfo.pingInterval||vga.webchat.connector.kiwi.DEFAULT_PING_INTERVAL,k=function(){c._pingId=setTimeout(function(){c.sendRawData("",vga.webchat.connector.kiwi.PACKET_STATUS.PING);k()},f)};k()}};vga.webchat.connector.kiwi.protocolwrapper.prototype.onConnect=function(a){this._state===vga.webchat.connector.kiwi.STATES.PROXY_CONNECTED&&(vga.util.debuglog.info("[vga.webchat.connector.kiwi.protocolwrapper.onConnect]: Received a PROXY_CONNECTED state, setting OPENED state."),
this._state=vga.webchat.connector.kiwi.STATES.OPENED,this._connectionInfo.connectionId=a.connection_id)};vga.webchat.connector.kiwi.protocolwrapper.prototype.onOpen=function(c,g){var d=this;this._state=vga.webchat.connector.kiwi.STATES.SOCKET_OPENED;vga.util.debuglog.info("[vga.webchat.connector.kiwi.protocolwrapper.onOpen]",c);this.sendRawData("",vga.webchat.connector.kiwi.PACKET_STATUS.UPGRADE);var b=function(){setTimeout(function(){d._state===vga.webchat.connector.kiwi.STATES.PROXY_CONNECTED?(d.sendRawData(h("client_info",
[{build_version:vga.webchat.connector.kiwi.CLIENT_VERSION.toString()}])),d.sendRawData(h("connect_irc",a(g)),void 0,!1)):d._state===vga.webchat.connector.kiwi.STATES.CLOSED?vga.util.debuglog.info("[vga.webchat.connector.kiwi.protocolwrapper.onOpen]: Received a CLOSED state before completing the transition to the PROXY_CONNECTED state."):b()},500)};b()};vga.webchat.connector.kiwi.protocolwrapper.prototype.onClose=function(a){vga.util.debuglog.info("[vga.webchat.connector.kiwi.protocolwrapper.onClose]: (State before close: "+
...
(function(){vga.webchat.ui.thememanager=function(a){a=a||{};this._themes=a.themes||[]};vga.webchat.ui.thememanager.prototype.start=function(){var a=this;if(0!==this._themes.length){var c=function(){a._themesIntervalId=setTimeout(function(){var h=new Date;a._themes.forEach(function(a){var c=new Date(a.beginDate),g=new Date(a.endDate);c.setFullYear(h.getFullYear());g.setFullYear(h.getFullYear());$("body").toggleClass(a.name,h>=c&&h<=g)});c()},1E3)};c()}};vga.webchat.ui.thememanager.prototype.stop=function(){clearTimeout(this._themesIntervalId)}})();vga=vga||{};vga.webchat=vga.webchat||{};
...
a)}function d(a,b){var e=$("#slide_message");e.text(a||"").toggleClass("hidden",!a);k(!1);b&&setTimeout(function(){e.fadeOut("slow",function(){e.toggleClass("hidden",!0).css("display","")})},b)}function g(a){if(!a)return $("");var e=r.find("#channel-tab-"+a.replace("#",""));if(0===e.length){var b=r.find("#channel-tab-template");e=b.clone();e.attr("id","channel-tab-"+a.replace("#","")).removeClass("hidden").data("channel",a).data("channel",a);b.addClass("hidden");r.append(e)}return e}function l(a){$.each(r.find(".channel-tab").not(a),
function(a,e){a=$(e);a.addClass("hidden");f(a,!1)});a.removeClass("hidden");f(a,!0)}function b(a){return g(a).find(".channel-window")}function f(a,b){a.find(".user-list-button").toggleClass("disabled",!b);a=a.find(".chatbox");a.prop("disabled",!b);b&&a.focus()}function q(a,c){var e=b(a);Array.isArray(c)?c.forEach(function(a){e.append('<div class="informative"><span class="message">'+vga.util.encodeHTML(a)+"</span></div>")}):e.append('<div class="informative text-center"><span class="message">'+vga.util.encodeHTML(c)+
"</span></div>")}function u(e,c){e=b(e).find(".user-entry[data-identity="+c.identity+"]");vga.webchat.getMostSignificantStatus(c.status)===vga.webchat.status.banned?e.remove():(c=a(c.roles),e.find(".role").removeClass().addClass("role "+c).find(".icon").attr("title",c))}function v(e){var b="";e.nicknames.forEach(function(a){b+=""+(0<b.length?",":"")+a});var c=vga.webchat.getMostSignificantStatus(e.status)===vga.webchat.status.banned?"banned":"";c=c?c:a(e.roles);return"<div data-identity='"+e.identity+
"' class='user-entry'><div class='role "+c+"'>"+('<div class="icon" title="'+c+'"></div>')+("<div class='username' title=\"Nicknames: "+b+'">'+e.identity+"</div>")+"</div></div>"}function w(a){a.html(a.find("div[data-identity]").sort(function(a,e){a=($(a).data("identity").toString()||"").toLowerCase();e=($(e).data("identity").toString()||"").toLowerCase();return a<e?-1:a>e?1:0}))}function t(a,b){var e=g(a).find(".user-list-wrapper .user-list");a=e.find(".mod-section-body");var m=e.find(".guest-section-body"),
d=e.find(".regular-section-body");e=e.find(".user-entry[data-identity="+b.identity+"]");if(0===b.nicknames.length)e.remove();else{var f=d;c(b.roles)?f=a:vga.webchat.getMostSignificantRole(b.roles)===vga.webchat.roles.guest&&(f=m);0!==e.length&&e.remove();f.append(v(b));w(f)}a.parent().toggleClass("hidden",0==a.find("div").length);m.parent().toggleClass("hidden",0==m.find("div").length);d.parent().toggleClass("hidden",0==d.find("div").length)}function z(a,b){a=g(a).find(".user-list-wrapper .user-list");
var e=a.find(".mod-section-body"),m=a.find(".guest-section-body"),d=a.find(".regular-section-body");e.html("");m.html("");d.html("");b&&vga.util.forEach(b,function(a,b){a=d;c(b.roles)?a=e:vga.webchat.getMostSignificantRole(b.roles)===vga.webchat.roles.guest&&(a=m);a.append(v(b));w(a)});e.parent().toggleClass("hidden",0===e.find("div").length);m.parent().toggleClass("hidden",0===m.find("div").length);d.parent().toggleClass("hidden",0===d.find("div").length)}var r=$(".channel-container"),x=$("#settings-container"),
...
!1,e=void 0!==a.enableReconnect?a.enableReconnect:!0,c=!this._defaultChannel;void 0!==a.enableFrashShowMode&&a.enableFrashShowMode&&this.setFrashShowMode(!0);this._debug&&vga.util.enableDebug();this.themeManager=new vga.webchat.ui.thememanager({themes:a.themes});this.scrollManager=new vga.webchat.ui.scrollmanager({$channelContainer:r,smoothScroll:a.smoothScroll});this.bindEvents();this.onLoadSettings();console.log("[vga.webchat.chat]: Starting chat version: "+vga.webchat.chat.CLIENT_VERSION.toString());
this.connector=new vga.webchat.connector.kiwi.connector(a.url,{supportConcurrentChannelJoins:a.supportConcurrentChannelJoins,autoJoinChannel:c,attemptReconnect:e,consolidateNicknames:b,listeners:[this]})};vga.webchat.chat.prototype.writeMessage=function(e,m,d,f){f=f||"message";var g=""+("action"===f?"allowColor":""),h="",p=this._userChannels[e];p&&(p=p[this.connector.getMyUserKey()])&&c(p.roles)&&(h='<span class="timeout"><i class="fa fa-ban" role="button" title="Timeout Chatter!"></i></span>');this._wallRegEx.test(d)&&
c(m.roles)&&(p=this._wallRegEx.exec(d),1<p.length&&(d=p[1],g="modbroadcast"));if(!this._frashShowMode&&this._hyperlinkRegEx&&this._hyperlinkRegEx.test(d)){this._hyperlinkRegEx.lastIndex=0;p=this._hyperlinkRegEx;var k="",n=0,l;for(p.lastIndex=0;(l=p.exec(d))&&!(k+=vga.util.encodeHTML(d.substring(n,l.index)),n=d.substr(l.index,l[0].length),k+="<a href='"+n+"' target='_blank'>"+vga.util.encodeHTML(n)+"</a>",n=p.lastIndex||0,0>p.flags.indexOf("g")););0<n&&(k+=vga.util.encodeHTML(d.substring(n)));d=k.trim()}else d=
vga.util.encodeHTML(d).trim();p=void 0!==m?m.identity.trim():"undefined";k=a(void 0!==m?m.roles:vga.webchat.roles.shadow);m=m.identity;n=this._nicknameColorSeedFunction&&this._nicknameColorSeedFunction()||0;for(l=0;l<m.length;l++)n+=m.charCodeAt(l);m=""+(n%7+1);n=p;"privateTO"===f?n="To ["+n+"]":"privateFROM"===f&&(n="From ["+n+"]");n=(n[0]||"").toLocaleUpperCase()+n.substring(1);b(e).append("<div class='user-entry nickColor"+m+"' data-identity='"+p+"'><div class='role "+k+"'>"+('<div class="icon" title="'+
k+'"></div>'+h)+("<span class='username allowColor'>"+n.trim()+("action"!==f?":&nbsp":"&nbsp")+"</span>")+("<span class='message "+g+"'>"+d+"</span>")+"</div></div>")};vga.webchat.chat.prototype.showToggleSetting=function(a,b){x.find(".settings-item[data-settings-type='"+a+"']").toggleClass("hidden",!b)};vga.webchat.chat.prototype.toggleSettingItem=function(a,b){x.find(".settings-item[data-settings-type='"+a+"'] > i").toggleClass("fa-toggle-off",!b).toggleClass("fa-toggle-on",b)};vga.webchat.chat.prototype.setFrashShowMode=
...
vga.webchat.status.timed);this.connector.setUserStatus(a,b,e,c?vga.webchat.roleModeAction.add:vga.webchat.roleModeAction.remove,{duration:this._timedBanDurationInSeconds})}return this};vga.webchat.chat.prototype.onConnect=function(a){d();h(!1);this.scrollManager.start();this.themeManager.start();q(a.channelKey,"VGA Chat version:"+vga.webchat.chat.CLIENT_VERSION.toString())};vga.webchat.chat.prototype.onDisconnect=function(a){this.scrollManager.stop();this.themeManager.stop();h(!0);a.closedByServer&&
d(a.reason,5E3);vga.util.forEach(this._userChannels,function(c,e){e=g(c);f(e,!1);b(c).toggleClass("pulse",!1);q(c,a.closedByServer?"Disconnected by the server.":"You have quit.")})};vga.webchat.chat.prototype.onReconnect=function(){d("The server stopped responding...retrying.",5E3);this.onLogin()};vga.webchat.chat.prototype.onTopic=function(a){q(a.channelKey,a.topic)};vga.webchat.chat.prototype.onChannelMode=function(a){var b=this._userChannels[a.channelKey];if(b){var c=g(a.channelKey);a.modes===
vga.webchat.channelmodes.turbo&&(this.toggleSettingItem("turbo-mode",a.action===vga.webchat.roleModeAction.add),a.action===vga.webchat.roleModeAction.add?(q(a.channelKey,"The room is now in TURBO only mode."),a=b[this.connector.getMyUserKey()],c.find("input.chatbox").prop("disabled",vga.webchat.getMostSignificantRole(a.roles)===vga.webchat.roles.shadow)):(q(a.channelKey,"The room is now free for all chatters."),c.find("input.chatbox").prop("disabled",!1)))}};vga.webchat.chat.prototype.onNick=function(a){vga.util.forEach(this._userChannels,
function(b,c){var e=c[a.userKey];e&&(e.identity=a.identity,e.removeNickname(a.nickname).addNickname(a.newNickName));a.userKey!==a.newUserKey&&(c[a.newUserKey]=e,c[a.userKey]=void 0);t(b,e);u(b,e)})};vga.webchat.chat.prototype.onMessage=function(a){var b=this;if(!this._wallRegEx.test(a.message)||!this._frashShowMode){var c=function(c,e,d){e&&b.writeMessage(c,e[a.userKey],a.message,d)};a.isChannel?c(a.target,this._userChannels[a.target],a.type):vga.util.forEach(this._userChannels,function(a,b){c(a,
b,"privateFROM")})}};vga.webchat.chat.prototype.onUserlist=function(a){this._userChannels[a.channelKey]=a.users;z(a.channelKey,a.users)};vga.webchat.chat.prototype.onJoin=function(a){if(a.isMe){var c=g(a.channelKey);l(c);b(a.channelKey).toggleClass("pulse",!1);q(a.channelKey,"Joined "+a.channelKey+" channel.")}else if(c=this._userChannels[a.channelKey]){var e=c[a.userKey];e||(e=new vga.webchat.userEntity(a.identity,a.nickname),c[a.userKey]=e,this._frashShowMode||!this._showUserJoinLeaveMessage||a.isMe||
this.writeMessage(a.channelKey,e,"has joined.","action"));e.addNickname(a.nickname);t(a.channelKey,e)}};vga.webchat.chat.prototype.onLeave=function(a){if(a.isMe)q(a.channelKey,"Left "+a.channelKey+" channel."),delete this._userChannels[a.channelKey],(a=Object.getOwnPropertyNames(this._userChannels).pop())?(a=g(a),l(a)):this.close("Bye VGA Webchat");else{var b=this._userChannels[a.channelKey];if(b){var c=b[a.userKey];c&&(c.removeNickname(a.nickname),0===c.nicknames.length&&(b[a.userKey]=void 0,this._frashShowMode||
!this._showUserJoinLeaveMessage||a.isMe||this.writeMessage(a.channelKey,c,"has left.","action")),t(a.channelKey,c))}}};vga.webchat.chat.prototype.onQuit=function(a){var b=this;vga.util.forEach(this._userChannels,function(c,e){b.onLeave({channelKey:c,userKey:a.userKey,nickname:a.nickname,isMe:a.IsMe})})};vga.webchat.chat.prototype.onRole=function(a){var b=this._userChannels[a.channelKey];if(b){var e=b[a.userKey];e&&(e.applyRoles(a.action,a.roles),t(a.channelKey,e),u(a.channelKey,e),a.isMe&&(a=b[this.connector.getMyUserKey()],
this.showToggleSetting("turbo-mode",a&&c(a.roles))))}};vga.webchat.chat.prototype.onStatus=function(a){var b=this._userChannels[a.channelKey];if(b){var c=function(c){if(c=b[c])c.applyStatus(a.action,a.status),t(a.channelKey,c),u(a.channelKey,c)};if("*"===a.userKey&&a.identities)for(var e=$jscomp.makeIterator(a.identities),d=e.next();!d.done;d=e.next())c(d.value);else c(a.userKey);a.isMe&&a.status===vga.webchat.status.banned&&q(a.channelKey,a.action===vga.webchat.roleModeAction.add?"You have been timed out.":
